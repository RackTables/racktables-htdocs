...
<div id="Content">
	...
	<div id="MainText">
		...
		<div class="Download"><h3>Check the</h3><div class="DownloadButton"><a href="demo.php">Live demo (<?php echo $demorelease; ?>)</a></div></div>
<div class="Download">
<?php if ( isset ($currentrelease) && $currentrelease !== $lastrelease) { ?>
		<h3>The current release<?php echo EXTLINKIMG; ?></h3><div class="DownloadButton">
...
<?php  } ?>
		<h3>The latest stable release<?php echo EXTLINKIMG; ?></h3><div class="DownloadButton">
